...
namespace BingoParser
{
  ...
  public struct DbfHeader
  {
    ...
    public Int32 NumberOfDataRows; // Numero di righe di dati presenti nel file DBF; 
    public Int16 FirstDataRowOffset; // posizione della prima riga di dati
    public Int16 RecordLen; // Lunghezza di ogni riga di dati, compreso il flag di cancellazione '*'
